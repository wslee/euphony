...
(check-synth)
(define-fun f_1 ((x (BitVec 64))) (BitVec 64) (ite (= (bvor #x0000000000000010 x) x) (ite (= (bvand #x0000000000000006 x) #x0000000000000000) (bvadd x x) (ite (= (bvand #x0000000000000005 x) #x0000000000000000) (bvadd x x) (bvudiv (bvlshr x #x0000000000000010) #x0000000000000008))) (ite (= (bvor #x000000000000000a x) x) (ite (= (bvsrem x #x0000000000000007) #x0000000000000000) (bvudiv (bvlshr x #x0000000000000010) #x0000000000000008) (bvudiv #x0000000000000008 x)) (ite (= (bvsrem x #x0000000000000003) #x0000000000000000) (ite (= (bvand #x0000000000000006 x) #x0000000000000000) (bvadd x x) (ite (= (bvand #x0000000000000009 x) #x0000000000000000) (bvadd x x) (bvudiv (bvlshr x #x0000000000000010) #x0000000000000008))) (ite (= (bvsrem x #x000000000000000a) #x0000000000000000) (bvudiv (bvlshr x #x0000000000000010) #x0000000000000008) (ite (= (bvsrem x #x0000000000000005) #x0000000000000000) (bvadd x x) (ite (= (bvand #x0000000000000002 x) #x0000000000000000) (ite (= (bvurem x #x0000000000000003) #x0000000000000001) (bvadd x x) (ite (= (bvand #x0000000000000008 x) #x0000000000000000) (ite (= (bvand #x000000000000000b x) #x0000000000000000) (bvadd x x) (ite (= (bvurem x #x0000000000000005) #x0000000000000001) (bvadd x x) (bvudiv #x0000000000000008 x))) (bvudiv #x0000000000000008 x))) (bvudiv #x0000000000000008 x))))))))
