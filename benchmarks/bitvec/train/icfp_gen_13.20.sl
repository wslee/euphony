...
(check-synth)
(define-fun f_1 ((x (BitVec 64))) (BitVec 64) (ite (= (bvsdiv #x0000000000000003 x) #x0000000000000000) (ite (= (bvand #x0000000000000009 x) #x0000000000000000) (ite (= (bvurem x #x0000000000000003) #x0000000000000001) (bvxor #x0000000000000001 x) (bvmul #x0000000000000004 x)) (ite (= (bvurem x #x0000000000000005) #x0000000000000000) (ite (= (bvor #x0000000000000009 x) x) (bvmul #x0000000000000004 x) (ite (= (bvurem x #x0000000000000003) #x0000000000000001) (ite (= (bvor #x0000000000000005 x) x) (bvmul #x0000000000000004 x) (bvxor #x0000000000000001 x)) (bvxor #x0000000000000001 x))) (ite (= (bvor #x0000000000000006 x) x) (bvxor #x0000000000000001 x) (ite (= (bvashr x x) #x0000000000000000) (ite (= (bvor #x0000000000000005 x) x) #x0000000000000001 (ite (= (bvand #x000000000000000a x) #x0000000000000000) (ite (= (bvurem x #x0000000000000003) #x0000000000000001) (bvxor #x0000000000000001 x) #x0000000000000001) (ite (= (bvurem x #x000000000000000b) #x0000000000000000) #x0000000000000001 (bvxor #x0000000000000001 x)))) (ite (= (bvor #x000000000000000c x) x) (bvxor #x0000000000000001 x) (ite (= (bvsrem x #x000000000000000f) #x0000000000000000) (ite (= (bvor #x0000000000000005 x) x) (bvmul #x0000000000000004 x) (bvxor #x0000000000000001 x)) (ite (= (bvand #x0000000000000010 x) #x0000000000000000) (ite (= (bvurem x #x0000000000000003) #x0000000000000001) (ite (= (bvand #x0000000000000002 x) #x0000000000000000) (bvmul #x0000000000000004 x) #x0000000000000001) #x0000000000000001) (ite (= (bvand #x0000000000000002 x) #x0000000000000000) (ite (= (bvurem x #x000000000000000d) #x0000000000000000) (bvmul #x0000000000000004 x) #x0000000000000001) (bvmul #x0000000000000004 x))))))))) #x0000000000000004))
