...
(check-synth)
(define-fun f_1 ((x (BitVec 64))) (BitVec 64) (ite (= (bvor #x0000000000000010 x) x) (ite (= (bvsdiv #x0000000000000001 x) #x0000000000000000) (ite (= (bvashr x x) #x0000000000000000) (ite (= (bvurem x #x0000000000000005) #x0000000000000001) x (ite (= (bvand #x0000000000000007 x) #x0000000000000000) x (ite (= (bvurem x #x0000000000000006) #x0000000000000001) (bvxor (bvudiv x #x0000000000000002) x) (ite (= (bvor #x0000000000000003 x) x) (bvor #x0000000000000001 x) (ite (= (bvurem x #x0000000000000009) #x0000000000000000) x (ite (= (bvand #x0000000000000008 x) #x0000000000000000) (ite (= (bvurem x #x0000000000000009) #x0000000000000001) x (ite (= (bvor #x0000000000000005 x) x) (ite (= (bvurem x #x000000000000000d) #x0000000000000000) (bvxor (bvudiv x #x0000000000000002) x) (bvor #x0000000000000001 x)) (bvxor (bvudiv x #x0000000000000002) x))) (bvxor (bvudiv x #x0000000000000002) x))))))) (bvxor (bvudiv x #x0000000000000002) x)) (bvnot (bvneg (bvadd x x)))) (ite (= (bvand #x0000000000000001 x) #x0000000000000000) (ite (= (bvurem x #x0000000000000009) #x0000000000000001) (bvor #x0000000000000001 x) (ite (= (bvurem x #x000000000000000a) #x0000000000000000) (ite (= (bvurem x #x000000000000000c) #x0000000000000000) (bvsub x (bvnot x)) (bvor #x0000000000000001 x)) (bvsub x (bvnot x)))) (ite (= (bvsrem x #x0000000000000005) #x0000000000000000) (bvnot (bvneg (bvadd x x))) (ite (= (bvurem x #x000000000000000b) #x0000000000000001) (bvneg (bvnot x)) (ite (= (bvurem x #x0000000000000009) #x0000000000000000) (bvxor #x0000000000000003 x) (ite (= (bvashr x x) #x0000000000000000) (ite (= (bvand #x000000000000000d x) #x0000000000000001) (ite (= (bvurem x #x0000000000000007) #x0000000000000001) (bvxor #x0000000000000003 x) (ite (= (bvor #x0000000000000002 x) x) (bvneg (bvnot x)) (bvnot (bvneg (bvadd x x))))) (bvnot (bvneg (bvadd x x)))) (ite (= (bvor #x0000000000000006 x) x) (bvnot (bvneg (bvadd x x))) (bvneg (bvnot x))))))))))
