...
(check-synth)
(define-fun f_1 ((x (BitVec 64))) (BitVec 64) (ite (= (bvand #x0000000000000001 x) #x0000000000000000) (bvxor (bvadd x x) #x0000000000000002) (ite (= (bvashr x x) #x0000000000000000) (ite (= (bvurem x #x0000000000000003) #x0000000000000000) (bvnot #x0000000000000000) (ite (= (bvurem x #x000000000000000d) #x0000000000000000) (bvnot #x0000000000000000) (ite (= (bvand #x000000000000000a x) #x0000000000000000) (bvxor (bvadd x x) #x0000000000000006) (ite (= (bvor #x0000000000000006 x) x) (bvneg (bvmul (bvnot x) #x0000000000000002)) (ite (= (bvor #x0000000000000010 x) x) (ite (= (bvor #x0000000000000009 x) x) (bvnot #x0000000000000000) (bvnot (bvurem (bvnot #x0000000000000002) x))) (bvnot #x0000000000000000)))))) (ite (= (bvurem x #x0000000000000009) #x0000000000000000) (ite (= (bvurem x #x0000000000000007) #x0000000000000000) (bvxor (bvadd x x) #x0000000000000006) (bvnot #x0000000000000000)) (bvneg (bvmul (bvnot x) #x0000000000000002))))))
