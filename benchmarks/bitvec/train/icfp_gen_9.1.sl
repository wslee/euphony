...
(check-synth)
(define-fun f_1 ((x (BitVec 64))) (BitVec 64) (ite (= (bvand #x0000000000000001 x) #x0000000000000000) (ite (= (bvand #x0000000000000010 x) #x0000000000000000) (ite (= (bvurem x #x000000000000000a) #x0000000000000000) #x0000000000000000 (ite (= (bvor #x0000000000000004 x) x) (bvlshr x #x0000000000000010) (ite (= (bvurem x #x0000000000000006) #x0000000000000000) #x0000000000000000 (ite (= (bvurem x #x000000000000000d) #x0000000000000000) #x0000000000000000 (bvlshr x #x0000000000000010))))) (bvudiv x #x0000000000000010)) (bvudiv x #x0000000000000010)))
