...
(check-synth)
(define-fun f_1 ((x (BitVec 64))) (BitVec 64) (ite (= (bvor #x0000000000000010 x) x) (ite (= (bvor #x0000000000000001 x) x) (bvxor (bvlshr x #x0000000000000010) #x0000000000000001) #x0000000000000002) #x0000000000000002))
