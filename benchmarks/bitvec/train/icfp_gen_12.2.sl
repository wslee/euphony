...
(constraint (= (f #x0000000000000029) #x00000000000000A4))
(check-synth)
(define-fun f_1 ((x (BitVec 64))) (BitVec 64) (ite (= (bvand #x0000000000000001 x) #x0000000000000000) (ite (= (bvlshr x #x0000000000000006) #x0000000000000000) (bvmul #x0000000000000004 x) (bvsub x (bvnot x))) (ite (= (bvand #x0000000000000010 x) #x0000000000000000) (bvmul #x0000000000000004 x) (ite (= (bvand #x000000000000000a x) #x0000000000000000) #x0000000000000004 (ite (= (bvurem x #x0000000000000005) #x0000000000000000) (bvmul #x0000000000000004 x) (ite (= (bvor #x0000000000000005 x) x) (bvmul #x0000000000000004 x) (ite (= (bvurem x #x0000000000000003) #x0000000000000000) (ite (= (bvand #x000000000000000c x) #x0000000000000000) #x0000000000000004 (ite (= (bvlshr x #x0000000000000006) #x0000000000000000) #x0000000000000004 (bvmul #x0000000000000004 x))) (ite (= (bvand #x000000000000000c x) #x0000000000000000) (bvmul #x0000000000000004 x) (ite (= (bvlshr x #x0000000000000006) #x0000000000000000) (bvmul #x0000000000000004 x) #x0000000000000004)))))))))
