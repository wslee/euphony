...
(check-synth)
(define-fun f_1 ((x (BitVec 64))) (BitVec 64) (ite (= (bvand #x0000000000000010 x) #x0000000000000000) (ite (= (bvand #x0000000000000005 x) #x0000000000000000) #x0000000000000001 (ite (= (bvurem x #x0000000000000005) #x0000000000000000) (ite (= (bvor #x0000000000000006 x) x) (bvadd x x) #x0000000000000001) (ite (= (bvand #x0000000000000003 x) #x0000000000000000) (ite (= (bvand #x0000000000000009 x) #x0000000000000000) (bvadd x x) (ite (= (bvurem x #x0000000000000007) #x0000000000000000) (bvadd x x) #x0000000000000001)) (ite (= (bvurem x #x0000000000000009) #x0000000000000000) (bvadd x x) (ite (= (bvurem x #x0000000000000003) #x0000000000000000) x (ite (= (bvor #x0000000000000003 x) x) x (bvadd x x))))))) (ite (= (bvand #x000000000000000d x) #x0000000000000000) (ite (= (bvand #x0000000000000003 x) #x0000000000000000) (bvadd x x) (ite (= (bvurem x #x000000000000000a) #x0000000000000000) x (ite (= (bvurem x #x0000000000000003) #x0000000000000000) (bvadd x x) x))) (ite (= (bvor #x0000000000000009 x) x) (ite (= (bvurem x #x0000000000000009) #x0000000000000000) (bvadd x x) (ite (= (bvurem x #x0000000000000007) #x0000000000000000) (bvadd x x) x)) (bvadd x x)))))
