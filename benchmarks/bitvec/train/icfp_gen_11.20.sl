...
(check-synth)
(define-fun f_1 ((x (BitVec 64))) (BitVec 64) (ite (= (bvor #x0000000000000002 x) x) (ite (= (bvsrem x #x0000000000000009) #x0000000000000000) (bvudiv (bvneg (bvnot x)) #x0000000000000002) (ite (= (bvor #x0000000000000005 x) x) (ite (= (bvurem x #x0000000000000009) #x0000000000000000) (bvshl (bvlshr x #x0000000000000006) #x0000000000000007) (bvneg (bvnot (bvudiv x #x0000000000000002)))) (ite (= (bvor #x0000000000000008 x) x) (ite (= (bvurem x #x0000000000000003) #x0000000000000001) (bvmul (bvudiv x #x0000000000000002) #x0000000000000004) (ite (= (bvurem x #x0000000000000006) #x0000000000000000) (ite (= (bvand #x0000000000000005 x) #x0000000000000000) (bvudiv x #x0000000000000002) (ite (= (bvand #x0000000000000010 x) #x0000000000000000) (bvmul (bvudiv x #x0000000000000002) #x0000000000000004) (ite (= (bvsrem x #x0000000000000003) #x0000000000000000) #x0000000000000004 (bvmul (bvudiv x #x0000000000000002) #x0000000000000004)))) (bvudiv x #x0000000000000002))) (ite (= (bvashr x x) #x0000000000000000) #x0000000000000004 (bvudiv x #x0000000000000002))))) (ite (= (bvand #x000000000000000d x) #x0000000000000001) (bvneg (bvnot (bvudiv x #x0000000000000002))) (ite (= (bvashr x x) #x0000000000000000) (ite (= (bvurem x #x0000000000000009) #x0000000000000000) (ite (= (bvand #x0000000000000005 x) #x0000000000000000) (bvmul (bvudiv x #x0000000000000002) #x0000000000000004) (ite (= (bvand #x0000000000000010 x) #x0000000000000000) (ite (= (bvurem x #x0000000000000007) #x0000000000000000) (bvneg (bvnot (bvudiv x #x0000000000000002))) (bvmul (bvudiv x #x0000000000000002) #x0000000000000004)) (bvneg (bvnot (bvudiv x #x0000000000000002))))) (ite (= (bvurem x #x0000000000000006) #x0000000000000000) (bvudiv x #x0000000000000002) (ite (= (bvurem x #x0000000000000007) #x0000000000000000) #x0000000000000000 (ite (= (bvand #x0000000000000010 x) #x0000000000000000) (ite (= (bvand #x0000000000000009 x) #x0000000000000001) (bvmul (bvudiv x #x0000000000000002) #x0000000000000004) #x0000000000000000) (bvmul (bvudiv x #x0000000000000002) #x0000000000000004))))) (bvmul (bvudiv x #x0000000000000002) #x0000000000000004)))))
