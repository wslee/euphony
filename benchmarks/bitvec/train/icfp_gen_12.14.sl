...
(check-synth)
(define-fun f_1 ((x (BitVec 64))) (BitVec 64) (ite (= (bvor #x0000000000000001 x) x) (ite (= (bvor #x0000000000000003 x) x) (ite (= (bvashr x x) #x0000000000000000) (ite (= (bvurem x #x0000000000000005) #x0000000000000000) #x0000000000000000 (ite (= (bvand #x0000000000000008 x) #x0000000000000000) #x0000000000000001 (ite (= (bvor #x0000000000000005 x) x) #x0000000000000000 (ite (= (bvand #x0000000000000010 x) #x0000000000000000) #x0000000000000001 #x0000000000000000)))) #x0000000000000001) #x0000000000000000) (ite (= (bvashr x x) #x0000000000000000) (ite (= (bvand #x0000000000000007 x) #x0000000000000000) #x0000000000000000 (ite (= (bvor #x0000000000000006 x) x) (ite (= (bvand #x0000000000000010 x) #x0000000000000000) #x0000000000000000 (bvudiv (bvmul #x0000000000000004 x) #x0000000000000002)) (ite (= (bvurem x #x000000000000000b) #x0000000000000000) (bvudiv (bvmul #x0000000000000004 x) #x0000000000000002) (ite (= (bvand #x0000000000000003 x) #x0000000000000000) (ite (= (bvand #x0000000000000010 x) #x0000000000000000) (bvudiv (bvmul #x0000000000000004 x) #x0000000000000002) #x0000000000000000) (bvudiv (bvmul #x0000000000000004 x) #x0000000000000002))))) (bvudiv (bvmul #x0000000000000004 x) #x0000000000000002))))
