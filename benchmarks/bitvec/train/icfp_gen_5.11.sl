...
(check-synth)
(define-fun f_1 ((x (BitVec 64))) (BitVec 64) (ite (= (bvand #x0000000000000001 x) #x0000000000000000) (ite (= (bvor #x0000000000000010 x) x) (bvnot (bvudiv x #x0000000000000010)) (ite (= (bvurem x #x000000000000000b) #x0000000000000000) x #x0000000000000000)) (ite (= (bvand #x0000000000000007 x) x) #x0000000000000001 (ite (= (bvashr x x) #x0000000000000000) (ite (= (bvurem x #x0000000000000005) #x0000000000000000) (ite (= (bvor #x0000000000000003 x) x) (ite (= (bvor #x0000000000000010 x) x) #x0000000000000001 (ite (= #x000000000000000f x) #x0000000000000001 (bvnot (bvudiv x #x0000000000000010)))) x) (ite (= (bvurem x #x000000000000000b) #x0000000000000000) x (ite (= (bvor #x0000000000000008 x) x) (ite (= (bvor #x0000000000000010 x) x) (ite (= (bvor #x0000000000000005 x) x) x (bvnot (bvudiv x #x0000000000000010))) (ite (= (bvor #x0000000000000005 x) x) (bvnot (bvudiv x #x0000000000000010)) x)) x))) (ite (= (bvurem x #x0000000000000003) #x0000000000000000) #x0000000000000001 (ite (= (bvor #x000000000000000d x) x) (ite (= (bvor #x0000000000000010 x) x) #x0000000000000001 (bvnot (bvudiv x #x0000000000000010))) (bvnot (bvudiv x #x0000000000000010))))))))
