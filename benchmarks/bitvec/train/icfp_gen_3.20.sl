...
(check-synth)
(define-fun f_1 ((x (BitVec 64))) (BitVec 64) (ite (= (bvand #x0000000000000008 x) #x0000000000000000) (ite (= (bvand #x0000000000000003 x) x) (bvudiv (bvnot x) #x0000000000000010) (bvor (bvudiv x #x0000000000000010) x)) (ite (= (bvashr x x) #x0000000000000000) (ite (= (bvsrem x #x0000000000000009) #x0000000000000001) (ite (= (bvor #x000000000000000f x) x) (bvxor (bvlshr x #x0000000000000010) #x0000000000000001) (bvlshr x #x0000000000000010)) (ite (= (bvsrem x #x000000000000000a) #x0000000000000001) #x0000000000000000 (ite (= (bvsrem x #x0000000000000003) #x0000000000000001) (ite (= (bvurem x #x0000000000000005) #x0000000000000000) (ite (= (bvurem x #x0000000000000007) #x0000000000000002) (bvlshr x #x0000000000000010) #x0000000000000000) #x0000000000000000) (ite (= (bvurem x #x0000000000000005) #x0000000000000002) (bvlshr x #x0000000000000010) (ite (= (bvurem x #x0000000000000007) #x0000000000000002) #x0000000000000000 (ite (= (bvurem x #x000000000000000e) #x0000000000000001) #x0000000000000000 (ite (= (bvor #x0000000000000003 x) x) (bvlshr x #x0000000000000010) (ite (= (bvand #x0000000000000003 x) #x0000000000000000) (bvlshr x #x0000000000000010) (ite (= (bvurem x #x0000000000000003) #x0000000000000000) (bvlshr x #x0000000000000010) (ite (= (bvor #x0000000000000001 x) x) #x0000000000000000 (ite (= (bvand #x0000000000000010 x) #x0000000000000000) #x0000000000000000 (bvlshr x #x0000000000000010)))))))))))) (bvlshr x #x0000000000000010))))
