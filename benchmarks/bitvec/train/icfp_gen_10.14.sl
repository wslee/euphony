...
(check-synth)
(define-fun f_1 ((x (BitVec 64))) (BitVec 64) (ite (= (bvand #x0000000000000001 x) #x0000000000000000) (ite (= #x0000000000000002 x) (bvneg (bvudiv x #x0000000000000002)) (ite (= (bvand #x000000000000000d x) #x0000000000000000) (ite (= (bvurem x #x0000000000000006) #x0000000000000000) (bvxor #x0000000000000001 x) #x0000000000000001) (bvxor #x0000000000000001 x))) (ite (= (bvor #x0000000000000002 x) x) (ite (not (= #x0000000000000003 x)) (ite (= (bvand #x0000000000000010 x) #x0000000000000000) (ite (= (bvor #x000000000000000b x) x) (ite (= (bvurem x #x0000000000000005) #x0000000000000000) (bvneg (bvudiv x #x0000000000000002)) (bvnot #x0000000000000000)) (bvneg (bvudiv x #x0000000000000002))) (bvneg (bvudiv x #x0000000000000002))) #x0000000000000004) (ite (= (bvand #x000000000000000e x) #x0000000000000000) (bvnot (bvudiv x #x0000000000000002)) (ite (= (bvand #x0000000000000010 x) #x0000000000000000) (bvnot #x0000000000000000) (ite (= (bvurem x #x0000000000000005) #x0000000000000000) (bvnot (bvudiv x #x0000000000000002)) (bvnot #x0000000000000000)))))))
