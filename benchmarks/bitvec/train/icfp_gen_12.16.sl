...
(check-synth)
(define-fun f_1 ((x (BitVec 64))) (BitVec 64) (ite (= (bvlshr x #x0000000000000005) #x0000000000000000) (ite (= (bvor #x0000000000000001 x) x) x (bvxor #x0000000000000002 x)) (ite (= (bvand #x0000000000000010 x) #x0000000000000000) (bvxor (bvadd x x) x) (ite (= (bvor #x0000000000000001 x) x) (ite (= (bvashr x x) #x0000000000000000) (ite (= (bvand #x000000000000000d x) #x0000000000000001) (bvxor (bvadd x x) x) (ite (= (bvor #x000000000000000b x) x) x (ite (= (bvsrem x #x0000000000000003) #x0000000000000000) (bvxor (bvadd x x) x) (ite (= (bvurem x #x0000000000000003) #x0000000000000001) (ite (= (bvand #x0000000000000004 x) #x0000000000000000) (bvxor (bvadd x x) x) (ite (= (bvurem x #x0000000000000005) #x0000000000000000) (bvxor (bvadd x x) x) x)) (ite (= (bvor #x0000000000000003 x) x) (ite (= (bvurem x #x000000000000000b) #x0000000000000000) (bvxor (bvadd x x) x) x) x))))) x) (bvxor (bvadd x x) x)))))
