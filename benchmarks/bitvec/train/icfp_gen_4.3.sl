...
(check-synth)
(define-fun f_1 ((x (BitVec 64))) (BitVec 64) (ite (= (bvor #x0000000000000001 x) x) (ite (= (bvsrem x #x0000000000000003) #x0000000000000000) (ite (= (bvsrem x #x0000000000000004) #x0000000000000001) (bvnot (bvneg x)) (ite (= (bvashr x x) #x0000000000000000) (bvnot (bvxor #x0000000000000001 x)) (ite (= (bvor #x000000000000000a x) x) (bvnot (bvneg x)) (ite (= (bvurem x #x000000000000000f) #x0000000000000001) (bvnot (bvxor #x0000000000000001 x)) (ite (= (bvand #x000000000000000a x) #x0000000000000002) (bvnot (bvneg x)) (ite (= (bvurem x #x0000000000000009) #x0000000000000001) (bvnot (bvneg x)) (bvnot (bvxor #x0000000000000001 x)))))))) (ite (= (bvurem x #x0000000000000003) #x0000000000000000) (bvnot (bvxor #x0000000000000001 x)) (ite (= (bvor #x0000000000000008 x) x) (ite (= (bvsrem x #x0000000000000005) #x0000000000000000) (bvnot (bvneg x)) (ite (= (bvurem x #x0000000000000005) #x0000000000000002) (bvnot #x0000000000000000) (ite (= (bvsrem x #x0000000000000006) #x0000000000000001) (bvnot #x0000000000000000) (ite (= (bvurem x #x000000000000000d) #x0000000000000001) (bvnot #x0000000000000000) (bvnot (bvneg x)))))) (ite (= (bvurem x #x0000000000000007) #x0000000000000001) (bvnot (bvneg x)) (ite (= (bvurem x #x0000000000000009) #x0000000000000001) (bvnot #x0000000000000000) (ite (= (bvurem x #x0000000000000005) #x0000000000000002) (bvnot (bvneg x)) (bvnot (bvxor #x0000000000000001 x)))))))) (ite (= (bvashr x x) #x0000000000000000) (ite (= (bvurem x #x000000000000000c) #x0000000000000000) (bvnot #x0000000000000000) (ite (= (bvurem x #x000000000000000d) #x0000000000000001) (ite (= (bvor #x000000000000000a x) x) (ite (= (bvurem x #x0000000000000009) #x0000000000000001) (bvnot #x0000000000000000) x) (bvnot #x0000000000000000)) (ite (= (bvsrem x #x000000000000000d) #x0000000000000000) (bvnot #x0000000000000000) (ite (= (bvurem x #x0000000000000006) #x0000000000000002) (ite (= (bvand #x0000000000000002 x) #x0000000000000000) (ite (= (bvurem x #x0000000000000005) #x0000000000000002) x (bvnot (bvxor #x0000000000000001 x))) (ite (= (bvurem x #x0000000000000005) #x0000000000000000) x (bvnot #x0000000000000000))) (ite (= (bvurem x #x0000000000000009) #x0000000000000001) (bvnot (bvxor #x0000000000000001 x)) (ite (= (bvurem x #x0000000000000007) #x0000000000000002) (bvnot (bvxor #x0000000000000001 x)) (ite (= (bvsrem x #x000000000000000b) #x0000000000000000) (bvnot (bvxor #x0000000000000001 x)) x))))))) (ite (= (bvor #x0000000000000010 x) x) x (bvnot (bvxor #x0000000000000001 x))))))
