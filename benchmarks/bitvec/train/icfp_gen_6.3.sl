...
(check-synth)
(define-fun f_1 ((x (BitVec 64))) (BitVec 64) (ite (= (bvor #x0000000000000001 x) x) (ite (= (bvor #x0000000000000008 x) x) (ite (= (bvor #x000000000000000b x) x) (ite (= (bvsrem x #x0000000000000004) #x0000000000000003) (ite (= (bvsrem x #x000000000000000b) #x0000000000000001) #x0000000000000001 x) (ite (= (bvurem x #x0000000000000003) #x0000000000000002) #x0000000000000001 (ite (= (bvurem x #x000000000000000d) #x0000000000000002) #x0000000000000001 (ite (= (bvurem x #x0000000000000007) #x0000000000000001) x (bvudiv x #x0000000000000002))))) (bvxor (bvudiv x #x0000000000000002) #x0000000000000001)) x) (ite (= (bvand #x000000000000000a x) #x0000000000000002) (ite (= (bvsrem x #x0000000000000005) #x0000000000000003) (bvudiv x #x0000000000000002) (ite (= (bvand #x0000000000000010 x) #x0000000000000000) (ite (= (bvurem x #x0000000000000007) #x0000000000000003) (bvudiv x #x0000000000000002) #x0000000000000001) (ite (= (bvand #x0000000000000005 x) #x0000000000000004) (bvudiv x #x0000000000000002) (ite (= (bvurem x #x0000000000000007) #x0000000000000002) (bvudiv x #x0000000000000002) #x0000000000000001)))) (ite (= (bvor #x000000000000000e x) x) (ite (= (bvurem x #x0000000000000007) #x0000000000000004) (bvor (bvlshr x #x0000000000000010) x) (bvudiv x #x0000000000000002)) (ite (= (bvurem x #x000000000000000c) #x0000000000000000) (bvxor (bvudiv x #x0000000000000002) #x0000000000000001) (ite (= (bvurem x #x0000000000000007) #x0000000000000000) (bvxor (bvudiv x #x0000000000000002) #x0000000000000001) (bvor (bvlshr x #x0000000000000010) x)))))))
