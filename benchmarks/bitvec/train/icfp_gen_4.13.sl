...
(check-synth)
(define-fun f_1 ((x (BitVec 64))) (BitVec 64) (ite (= (bvor #x0000000000000001 x) x) (ite (= (bvor #x000000000000000e x) x) (bvnot #x0000000000000000) (ite (= (bvurem x #x000000000000000f) #x0000000000000000) (bvnot #x0000000000000000) (ite (= (bvsrem x #x0000000000000007) #x0000000000000000) (bvnot #x0000000000000000) (ite (= (bvor #x0000000000000004 x) x) (bvnot x) (ite (= (bvand #x000000000000000e x) #x0000000000000000) (bvnot x) (ite (= (bvsrem x #x000000000000000f) #x0000000000000000) (bvnot #x0000000000000000) (ite (= (bvurem x #x0000000000000005) #x0000000000000000) (bvnot #x0000000000000000) (ite (= (bvor #x000000000000000a x) x) (bvnot x) (ite (= (bvurem x #x0000000000000003) #x0000000000000001) (bvnot x) (ite (= (bvsrem x #x0000000000000005) #x0000000000000000) (bvnot x) (ite (= (bvand #x0000000000000008 x) #x0000000000000000) (bvnot #x0000000000000000) (ite (= (bvashr x x) #x0000000000000000) (bvnot #x0000000000000000) (bvnot x))))))))))))) (ite (= (bvor #x0000000000000010 x) x) (ite (= (bvurem x #x0000000000000005) #x0000000000000001) (bvnot #x0000000000000000) (ite (= (bvor #x0000000000000004 x) x) (ite (= (bvsrem x #x0000000000000005) #x0000000000000000) (bvnot x) (ite (= (bvor #x000000000000000e x) x) (ite (= (bvurem x #x0000000000000009) #x0000000000000000) (bvnot #x0000000000000000) (bvnot x)) (bvnot #x0000000000000000))) (bvnot x))) (bvlshr x #x0000000000000005))))
