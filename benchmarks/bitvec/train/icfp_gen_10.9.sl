...
(check-synth)
(define-fun f_1 ((x (BitVec 64))) (BitVec 64) (ite (= (bvand #x0000000000000002 x) #x0000000000000000) #x0000000000000002 (ite (= (bvand #x000000000000000c x) #x0000000000000000) (bvnot (bvmul #x0000000000000008 x)) (ite (= (bvsrem x #x0000000000000003) #x0000000000000000) (bvnot (bvmul #x0000000000000004 x)) (ite (= (bvurem x #x0000000000000007) #x0000000000000000) (bvnot (bvmul #x0000000000000008 x)) (ite (= (bvurem x #x0000000000000009) #x0000000000000000) (bvnot (bvmul #x0000000000000008 x)) (ite (= (bvsrem x #x0000000000000005) #x0000000000000000) (bvnot (bvmul #x0000000000000008 x)) (ite (= (bvurem x #x000000000000000a) #x0000000000000000) (bvnot (bvmul #x0000000000000008 x)) (ite (= (bvurem x #x0000000000000003) #x0000000000000000) (bvnot (bvmul #x0000000000000004 x)) (ite (= (bvor #x000000000000000e x) x) (bvnot (bvmul #x0000000000000008 x)) (bvnot (bvmul #x0000000000000004 x))))))))))))
