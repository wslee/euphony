...
(check-synth)
(define-fun f_1 ((x (BitVec 64))) (BitVec 64) (ite (= (bvor #x0000000000000001 x) x) (ite (= (bvxor #x0000000000000010 #x0000000000000009) x) #x0000000000000001 (ite (= (bvxor #x0000000000000010 #x000000000000000f) x) #x0000000000000001 (ite (= (bvxor #x0000000000000010 #x0000000000000007) x) #x0000000000000001 (ite (= (bvxor #x0000000000000010 #x0000000000000003) x) #x0000000000000001 #x0000000000000000)))) (bvadd (bvlshr x #x0000000000000005) x)))
