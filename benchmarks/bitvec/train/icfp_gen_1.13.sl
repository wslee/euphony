...
(check-synth)
(define-fun f_1 ((x (BitVec 64))) (BitVec 64) (ite (= (bvand #x000000000000000e x) #x0000000000000000) (ite (= (bvsrem x #x0000000000000003) #x0000000000000000) (bvudiv x #x0000000000000010) #x0000000000000000) (ite (= (bvurem x #x000000000000000a) #x0000000000000000) (bvudiv x #x0000000000000010) (ite (= (bvurem x #x0000000000000006) #x0000000000000000) (bvudiv x #x0000000000000010) (ite (= (bvashr x x) #x0000000000000000) (ite (= (bvand #x0000000000000010 x) #x0000000000000000) (bvudiv x #x0000000000000010) (ite (= (bvor #x0000000000000002 x) x) #x0000000000000000 (ite (= (bvurem x #x0000000000000007) #x0000000000000000) #x0000000000000000 (ite (= (bvand #x0000000000000001 x) #x0000000000000000) (bvudiv x #x0000000000000010) (ite (= (bvsrem x #x0000000000000003) #x0000000000000000) (bvudiv x #x0000000000000010) #x0000000000000000))))) #x0000000000000000)))))
