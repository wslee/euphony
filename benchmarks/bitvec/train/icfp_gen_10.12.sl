...
(check-synth)
(define-fun f_1 ((x (BitVec 64))) (BitVec 64) (ite (= (bvor #x0000000000000001 x) x) (bvnot x) (ite (= (bvand #x000000000000000c x) #x0000000000000000) (ite (= (bvand #x0000000000000002 x) #x0000000000000000) (bvudiv x #x0000000000000002) (ite (= (bvsrem x #x0000000000000003) #x0000000000000000) (bvudiv x #x0000000000000002) (ite (= (bvurem x #x0000000000000005) #x0000000000000000) (bvudiv x #x0000000000000002) (ite (= (bvurem x #x0000000000000003) #x0000000000000000) (bvudiv x #x0000000000000002) (bvnot x))))) (bvudiv x #x0000000000000002))))
