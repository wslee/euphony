...
(check-synth)
(define-fun f_1 ((x (BitVec 64))) (BitVec 64) (ite (= (bvand #x0000000000000010 x) #x0000000000000000) (ite (not (= #x0000000000000002 x)) (ite (= (bvudiv #x0000000000000002 x) #x0000000000000000) (ite (= (bvand #x0000000000000006 x) #x0000000000000000) (ite (= (bvurem x #x0000000000000009) #x0000000000000000) (bvsub x (bvnot x)) (ite (= (bvurem x #x0000000000000003) #x0000000000000000) (bvxor #x0000000000000003 x) (bvsub x (bvnot x)))) (bvsub x (bvnot x))) #x0000000000000002) #x0000000000000000) (ite (= (bvand #x0000000000000009 x) #x0000000000000000) (ite (= (bvurem x #x0000000000000006) #x0000000000000000) (bvlshr x #x0000000000000010) (bvlshr (bvnot #x0000000000000000) #x0000000000000010)) (bvlshr x #x0000000000000010))))
