...
(check-synth)
(define-fun f_1 ((x (BitVec 64))) (BitVec 64) (ite (= (bvand #x0000000000000001 x) #x0000000000000000) #x0000000000000001 (ite (= (bvand #x0000000000000008 x) #x0000000000000000) (ite (= #x0000000000000001 x) (bvlshr x #x000000000000000e) (ite (= (bvurem x #x000000000000000d) #x0000000000000000) (bvnot (bvneg (bvlshr x #x000000000000000e))) (ite (= (bvurem x #x0000000000000007) #x0000000000000000) (bvnot (bvneg (bvlshr x #x000000000000000e))) (bvxor (bvlshr x #x000000000000000e) #x0000000000000002)))) (ite (= (bvor #x0000000000000007 x) x) (ite (= (bvor #x0000000000000010 x) x) (bvxor (bvlshr x #x000000000000000e) #x0000000000000002) (bvxor (bvlshr x #x000000000000000e) #x0000000000000003)) (ite (= (bvurem x #x000000000000000b) #x0000000000000000) (bvxor (bvlshr x #x000000000000000e) #x0000000000000002) (bvlshr x #x000000000000000e))))))
