...
(check-synth)
(define-fun f_1 ((x (BitVec 64))) (BitVec 64) (ite (= (bvor #x0000000000000001 x) x) (ite (= #x000000000000000b x) #x0000000000000001 (ite (= #x0000000000000007 x) #x0000000000000001 (ite (= #x0000000000000003 x) #x0000000000000001 (ite (= #x000000000000000f x) #x0000000000000001 x)))) (ite (= (bvnot #x0000000000000001) x) (bvnot #x0000000000000003) (bvxor (bvadd x x) #x0000000000000002))))
