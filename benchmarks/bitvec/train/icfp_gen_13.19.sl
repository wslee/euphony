...
(check-synth)
(define-fun f_1 ((x (BitVec 64))) (BitVec 64) (ite (= (bvand #x0000000000000003 x) #x0000000000000000) #x0000000000000000 (ite (= (bvor #x0000000000000001 x) x) (bvlshr (bvshl x #x0000000000000010) #x0000000000000010) (ite (= (bvashr x x) #x0000000000000000) (ite (= (bvand #x0000000000000009 x) #x0000000000000000) (ite (= (bvor #x0000000000000006 x) x) (ite (= (bvurem x #x0000000000000003) #x0000000000000000) (bvlshr (bvshl x #x0000000000000010) #x0000000000000010) (ite (= (bvurem x #x0000000000000005) #x0000000000000000) (bvlshr (bvshl x #x0000000000000010) #x0000000000000010) #x0000000000000000)) (bvlshr (bvshl x #x0000000000000010) #x0000000000000010)) #x0000000000000000) (bvlshr (bvshl x #x0000000000000010) #x0000000000000010)))))
