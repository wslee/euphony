...
(check-synth)
(define-fun f_1 ((x (BitVec 64))) (BitVec 64) (ite (= (bvor #x0000000000000001 x) x) (bvudiv x #x0000000000000004) (ite (= (bvor #x0000000000000002 x) x) (ite (= (bvor #x0000000000000008 x) x) #x0000000000000000 (ite (= (bvor #x0000000000000004 x) x) #x0000000000000000 (bvudiv x #x0000000000000004))) #x0000000000000000)))
