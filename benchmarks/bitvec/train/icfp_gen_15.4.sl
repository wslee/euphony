...
(check-synth)
(define-fun f_1 ((x (BitVec 64))) (BitVec 64) (ite (= #x0000000000000002 x) x (ite (= (bvand #x000000000000000a x) #x0000000000000000) (ite (= (bvand #x0000000000000005 x) #x0000000000000000) (ite (= (bvand #x0000000000000010 x) #x0000000000000000) (bvxor #x0000000000000002 x) (bvnot (bvadd x x))) (bvxor #x0000000000000002 x)) (ite (= (bvurem x #x0000000000000003) #x0000000000000000) (bvnot (bvadd x x)) (ite (= (bvand #x0000000000000003 x) #x0000000000000000) (bvnot (bvadd x x)) (ite (= (bvand #x0000000000000010 x) #x0000000000000000) (ite (= (bvor #x0000000000000005 x) x) (ite (= (bvor #x000000000000000a x) x) (ite (= (bvurem x #x0000000000000005) #x0000000000000000) (bvxor #x0000000000000002 x) (bvnot (bvadd x x))) (bvxor #x0000000000000002 x)) (ite (= (bvurem x #x0000000000000005) #x0000000000000000) (bvnot (bvadd x x)) (ite (= (bvand #x0000000000000005 x) #x0000000000000000) (bvxor #x0000000000000002 x) (bvnot (bvadd x x))))) (bvxor #x0000000000000002 x)))))))
