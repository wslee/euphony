...
(check-synth)
(define-fun f_1 ((x (BitVec 64))) (BitVec 64) (ite (= (bvand #x0000000000000001 x) #x0000000000000000) (ite (= (bvor #x0000000000000010 x) x) (ite (= (bvor #x0000000000000002 x) x) (ite (= (bvor #x0000000000000004 x) x) (ite (= (bvurem x #x0000000000000009) #x0000000000000000) (ite (= (bvurem x #x0000000000000005) #x0000000000000001) x (bvxor #x0000000000000001 x)) (bvxor #x0000000000000001 x)) x) (bvxor #x0000000000000001 x)) (ite (= (bvor #x0000000000000002 x) x) (bvxor #x0000000000000001 x) (ite (= (bvand #x000000000000000a x) #x0000000000000000) x (ite (= (bvor #x0000000000000004 x) x) x (ite (= (bvurem x #x0000000000000005) #x0000000000000000) x (bvxor #x0000000000000001 x)))))) (ite (= (bvurem x #x0000000000000005) #x0000000000000001) (bvnot (bvxor (bvudiv x #x0000000000000002) x)) (ite (= (bvurem x #x0000000000000003) #x0000000000000000) (bvnot (bvxor (bvudiv x #x0000000000000002) x)) (ite (= (bvor #x0000000000000009 x) x) x (ite (= (bvurem x #x0000000000000003) #x0000000000000001) (ite (= (bvsrem x #x0000000000000003) #x0000000000000000) (bvnot (bvxor (bvudiv x #x0000000000000002) x)) x) (bvnot (bvxor (bvudiv x #x0000000000000002) x))))))))
