...
(check-synth)
(define-fun f_1 ((x (BitVec 64))) (BitVec 64) (ite (= (bvor #x0000000000000003 x) x) (ite (= (bvurem x #x0000000000000007) #x0000000000000001) (bvudiv (bvnot x) #x000000000000000e) (bvneg (bvnot (bvudiv x #x0000000000000002)))) (ite (= (bvor #x0000000000000002 x) x) (ite (= (bvashr x x) #x0000000000000000) (bvudiv x #x0000000000000002) (ite (= (bvurem x #x0000000000000009) #x0000000000000000) (bvnot (bvxor (bvadd x x) #x0000000000000003)) (ite (= (bvor #x000000000000000a x) x) (bvudiv x #x0000000000000002) (ite (= (bvurem x #x0000000000000007) #x0000000000000001) (bvudiv x #x0000000000000002) (bvnot (bvxor (bvadd x x) #x0000000000000003)))))) (ite (= (bvand #x0000000000000001 x) #x0000000000000000) (bvnot (bvxor (bvadd x x) #x0000000000000003)) (ite (= (bvurem x #x0000000000000007) #x0000000000000000) (bvneg (bvnot (bvudiv x #x0000000000000002))) (ite (= (bvand #x0000000000000004 x) #x0000000000000000) (ite (= (bvor #x0000000000000009 x) x) (bvneg (bvnot (bvudiv x #x0000000000000002))) (ite (= (bvurem x #x000000000000000d) #x0000000000000000) (bvneg (bvnot (bvudiv x #x0000000000000002))) (ite (= (bvor #x0000000000000010 x) x) (bvnot (bvxor (bvadd x x) #x0000000000000003)) (ite (= (bvurem x #x0000000000000009) #x0000000000000001) (bvnot (bvxor (bvadd x x) #x0000000000000003)) (bvneg (bvnot (bvudiv x #x0000000000000002))))))) (bvnot (bvxor (bvadd x x) #x0000000000000003))))))))
