...
(check-synth)
(define-fun f_1 ((x (BitVec 64))) (BitVec 64) (ite (= (bvlshr x #x0000000000000010) #x0000000000000000) #x0000000000000001 (ite (= (bvurem x #x000000000000000f) #x0000000000000000) (bvudiv x #x0000000000000010) (ite (= (bvashr x x) #x0000000000000000) (ite (= (bvand #x0000000000000005 x) #x0000000000000000) (bvnot (bvneg (bvlshr x #x0000000000000010))) (bvudiv x #x0000000000000010)) (ite (= (bvor #x0000000000000007 x) x) (ite (= (bvsrem x #x0000000000000009) #x0000000000000000) (bvudiv x #x0000000000000010) #x0000000000000001) (ite (= (bvand #x0000000000000005 x) #x0000000000000000) (ite (= (bvand #x0000000000000010 x) #x0000000000000000) (bvxor (bvlshr x #x0000000000000010) #x0000000000000001) #x0000000000000001) (bvxor (bvlshr x #x0000000000000010) #x0000000000000001)))))))
