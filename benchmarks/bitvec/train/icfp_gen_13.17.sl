...
(constraint (= (f #xFFFFFFFFFFFFFFFF) #xFFFFFFFFFFFFFFFE))
(check-synth)
(define-fun f_1 ((x (BitVec 64))) (BitVec 64) (ite (= (bvor #x0000000000000001 x) x) (ite (= (bvashr x x) #x0000000000000000) (ite (= (bvurem x #x000000000000000f) #x0000000000000000) (ite (= (bvor #x0000000000000010 x) x) (bvxor #x0000000000000003 x) (bvadd x x)) (ite (= (bvsrem x #x000000000000000e) #x0000000000000001) (ite (= (bvurem x #x0000000000000003) #x0000000000000001) (bvadd x x) (bvnot x)) (ite (= (bvurem x #x0000000000000005) #x0000000000000001) (bvneg (bvnot x)) (ite (= (bvsrem x #x000000000000000d) #x0000000000000000) (bvxor #x0000000000000003 x) (ite (= (bvand #x000000000000000f x) #x0000000000000001) (bvxor #x0000000000000003 x) (ite (= (bvand #x000000000000000d x) #x0000000000000001) (bvnot x) (ite (= (bvor #x000000000000000e x) x) (bvneg (bvnot x)) (ite (= (bvurem x #x0000000000000003) #x0000000000000000) (ite (= (bvor #x0000000000000010 x) x) (bvnot x) (bvneg (bvnot x))) (ite (= (bvurem x #x0000000000000007) #x0000000000000000) (ite (= (bvor #x0000000000000006 x) x) (bvnot x) (bvneg (bvnot x))) (ite (= (bvor #x0000000000000009 x) x) (bvnot x) (ite (= (bvsrem x #x0000000000000005) #x0000000000000000) (bvnot x) (bvxor #x0000000000000003 x)))))))))))) (ite (= (bvor #x0000000000000009 x) x) (ite (= (bvurem x #x0000000000000003) #x0000000000000001) (bvnot x) (bvadd x x)) (bvadd x x))) (ite (= (bvsrem x #x000000000000000d) #x0000000000000000) (bvneg (bvnot x)) (ite (= (bvurem x #x0000000000000005) #x0000000000000000) (bvnot x) (ite (= (bvurem x #x0000000000000003) #x0000000000000001) (ite (= (bvand #x0000000000000007 x) #x0000000000000000) (bvneg (bvnot x)) (bvnot x)) (ite (= (bvurem x #x000000000000000d) #x0000000000000001) (bvsub x (bvnot x)) (ite (= (bvor #x0000000000000010 x) x) (ite (= (bvurem x #x0000000000000005) #x0000000000000001) (bvsub x (bvnot x)) (ite (= (bvsrem x #x0000000000000009) #x0000000000000000) (bvsub x (bvnot x)) (ite (= (bvand #x000000000000000d x) #x0000000000000000) (bvneg (bvnot x)) (ite (= (bvsrem x #x0000000000000006) #x0000000000000000) (bvneg (bvnot x)) (bvnot x))))) (ite (= (bvurem x #x0000000000000005) #x0000000000000002) (ite (= (bvsrem x #x0000000000000006) #x0000000000000000) (bvnot x) (bvsub x (bvnot x))) (bvnot x)))))))))
