...
(check-synth)
(define-fun f_1 ((x (BitVec 64))) (BitVec 64) (ite (= (bvor #x0000000000000001 x) x) (ite (= (bvor #x0000000000000003 x) x) (bvnot x) (ite (= (bvand #x0000000000000006 x) #x0000000000000000) (ite (= (bvurem x #x0000000000000003) #x0000000000000000) (bvnot x) (ite (= (bvand #x0000000000000010 x) #x0000000000000000) (bvnot x) (ite (= (bvurem x #x0000000000000005) #x0000000000000000) (bvnot x) (bvnot #x0000000000000000)))) (ite (= (bvurem x #x000000000000000b) #x0000000000000000) (bvnot x) (bvnot #x0000000000000000)))) (ite (= (bvurem x #x000000000000000c) #x0000000000000000) #x0000000000000000 (ite (= (bvand #x0000000000000010 x) #x0000000000000000) x (ite (= (bvurem x #x0000000000000006) #x0000000000000000) #x0000000000000000 (ite (= (bvor #x0000000000000008 x) x) x (ite (= (bvsrem x #x0000000000000005) #x0000000000000000) x #x0000000000000000)))))))
