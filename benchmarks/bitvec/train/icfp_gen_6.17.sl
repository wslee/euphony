...
(check-synth)
(define-fun f_1 ((x (BitVec 64))) (BitVec 64) (ite (= (bvand #x0000000000000002 x) #x0000000000000000) (ite (= (bvashr x x) #x0000000000000000) (ite (= (bvurem x #x000000000000000f) #x0000000000000000) (bvudiv (bvadd x x) #x0000000000000010) (bvxor #x0000000000000001 x)) (ite (= (bvurem x #x0000000000000007) #x0000000000000000) (bvnot x) (ite (= (bvsrem x #x0000000000000006) #x0000000000000000) (bvnot x) (ite (= (bvand #x0000000000000004 x) #x0000000000000000) (ite (= (bvurem x #x000000000000000f) #x0000000000000000) (bvxor #x0000000000000001 x) (ite (= (bvsrem x #x0000000000000005) #x0000000000000000) (bvxor #x0000000000000001 x) (ite (= (bvsrem x #x0000000000000003) #x0000000000000000) (ite (= (bvand #x0000000000000010 x) #x0000000000000000) (bvxor #x0000000000000001 x) (bvnot x)) (bvnot x)))) (bvxor #x0000000000000001 x))))) (ite (= (bvand #x000000000000000d x) #x0000000000000000) (ite (= (bvurem x #x000000000000000d) #x0000000000000000) (bvudiv (bvadd x x) #x0000000000000010) (ite (= (bvsrem x #x0000000000000003) #x0000000000000000) (bvudiv (bvadd x x) #x0000000000000010) #x0000000000000000)) (bvudiv (bvadd x x) #x0000000000000010))))
